            ...
            [
                ...
                new FunctionalModuleDefinition(
                    ...
                    [
                        ...
                        new FunctionalScenarioRow("Важно", "Прайс-листы", "Быстрая выгрузка прайс-листа по видам цен и сегментам.", "PriceType, NomenclatureItem, DiscountPolicy", "Реализована CSV-выгрузка из каталога с видами цен и активными скидками.", "Следующий шаг: добавить шаблоны прайс-листов под разные каналы продаж.")
                    ]),
                new FunctionalModuleDefinition(
                    "platform",
                    ...
                    [
                        ...
                        new FunctionalScenarioRow("Критично", "Права и рабочие места", "Разные экраны и разрешения для продаж, закупок, склада и админов.", "Пользователи, роли, UI-workspaces", "Базовые рабочие места разделены навигацией; строгая ролевая модель требует бизнес-правил.", "Следующий шаг: согласовать роли и запреты действий перед включением ограничений."),
                        ...
                        new FunctionalScenarioRow("Важно", "Печатные формы и экспорт", "Счет, накладная, заказ, инвентаризация, выгрузки для бухгалтерии и склада.", "Документы продаж, закупок и склада", "Реализованы CSV/HTML-выгрузки и печатные компоновщики для ключевых документов.", "Следующий шаг: согласовать фирменные шаблоны печатных форм."),
                        new FunctionalScenarioRow("Важно", "Аудит и вложения", "История изменений, сканы документов, комментарии и причины операций.", "Документы и журнал событий", "Журналы операций реализованы по продажам, закупкам, складу и каталогу; вложения требуют отдельного хранилища.", "Следующий шаг: выбрать место хранения файлов и правила доступа к вложениям.")
                    ])
            ]);
    }
}
